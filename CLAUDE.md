...
**저장 위치:**
```
frontend/public/data/words.json      # 단어 (pos ≠ 文)
frontend/public/data/sentences.json  # 문장 (pos = 文)
```
...
### Step 4: Git 커밋 & 푸시
```bash
git add frontend/public/data/words.json frontend/public/data/sentences.json
