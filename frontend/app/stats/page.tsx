          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between py-4 border-y border-neutral-100">
              <div className="text-center">
                ...
                <p className="text-[10px] text-neutral-500 mt-1">연속 학습일</p>
              </div>
              <div className="h-12 w-px bg-neutral-100" />
              <div className="text-center">
                <p className="text-3xl">{streak.totalDays}</p>
                <p className="text-[10px] text-neutral-500 mt-1">총 학습일</p>
              </div>
              <div className="h-12 w-px bg-neutral-100" />
              <div className="text-center">
                <p className="text-3xl">{streak.longestStreak}</p>
                <p className="text-[10px] text-neutral-500 mt-1">최장 기록</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-xs text-neutral-500">90일 로드맵</p>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-xs text-neutral-500">오늘의 목표</p>
                <button
                  onClick={() => setShowGoalSettings(!showGoalSettings)}
                  className="text-[10px] text-neutral-500 hover:text-neutral-600"
                >
            ...
            {/* Vocabulary Stats */}
            <div className="space-y-3 pt-4 border-t border-neutral-100">
              <p className="text-xs text-neutral-500">단어장 현황</p>
              <div className="grid grid-cols-2 gap-px bg-neutral-100">
                <div className="bg-white p-4 text-center">
                  <p className="text-2xl">{stats.total}</p>
                  <p className="text-[10px] text-neutral-500 mt-1">전체</p>
                </div>
                <div className="bg-white p-4 text-center">
                  <p className="text-2xl">{stats.dueToday}</p>
                  <p className="text-[10px] text-neutral-500 mt-1">오늘 복습</p>
                </div>
                <div className="bg-white p-4 text-center">
                  <p className="text-2xl">{stats.learned}</p>
                  <p className="text-[10px] text-neutral-500 mt-1">학습 중</p>
                </div>
                <div className="bg-white p-4 text-center">
                  <p className="text-2xl">{stats.mastered}</p>
                  <p className="text-[10px] text-neutral-500 mt-1">마스터</p>
                </div>
              </div>
            </div>
            ...
            {/* Phase Guide */}
            <div className="space-y-3 pt-4 border-t border-neutral-100">
              <p className="text-xs text-neutral-500">90일 로드맵 가이드</p>
            ...
            <div className="space-y-3 pt-4 border-t border-neutral-100">
              <div className="flex items-center justify-between">
                <p className="text-xs text-neutral-500">AI 피드백 설정</p>
                <button
  ...
  return (
    <div className={`p-3 rounded ${achieved ? "bg-neutral-900 text-white" : "bg-neutral-50"}`}>
      <div className="flex justify-between items-center mb-2">
        <span className={`text-[10px] ${achieved ? "text-neutral-400" : "text-neutral-500"}`}>
          {label}
        </span>
      ...
      <p className="text-lg">
        {current}
        <span className={`text-xs ${achieved ? "text-neutral-500" : "text-neutral-500"}`}>
          /{target}{suffix}
        </span>
      </p>
